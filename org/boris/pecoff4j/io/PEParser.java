...
//TODO - Move this entire thirdparty package into ant.properties by checking in the thirdparty data
...
public class PEParser {
  ...
  private static void readImageData( PE pe,  DataEntry entry,  IDataReader dr)
    ...
    switch (entry.index) {
      ...
      case ImageDataDirectoryType.RESOURCE_TABLE:
        ResourceDirectory rd = readResourceDirectory(b,entry.baseAddress);
  ...
  private static void readDebugRawData( PE pe,
                                        DataEntry entry,
  ...
  public static ImportDirectoryTable readImportDirectoryTable( final IDataReader dr,
                                                              final int baseAddress) throws IOException {
