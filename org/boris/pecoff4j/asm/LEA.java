...
public class LEA extends AbstractInstruction {
  ...
  public String toIntelAssembly() {
    if (sib != null) {
      return "lea  " + Register.to32(modrm.reg2) + ", [" + sib.toString(imm32) + "]";//NO i18N
    }
    return "lea  " + Register.to32(modrm.reg2) + ", [" + Register.to32(modrm.reg1) + toHexString(imm32, true) + "]";//NO i18N
  }
}
