  ...
  public String toIntelAssembly() {
    switch (((int) code[0]) & 0xff) {
      case 0x8b:
        switch (modrm.mod) {
          case 0:
            return "mov  [" + Register.to32(modrm.reg2) + "], " + Register.to32(modrm.reg1);//NO i18N
          case 1:
            return "mov  " + Register.to32(modrm.reg2) + ", [" + Register.to32(modrm.reg1) + toHexString((byte) imm32, true) + "]";//NO i18N
          case 2:
            return "mov  " + Register.to32(modrm.reg2) + ", [" + Register.to32(modrm.reg1) + toHexString(imm32, true) + "]";//NO i18N
          case 3:
            return "mov  " + Register.to32(modrm.reg2) + ", " + Register.to32(modrm.reg1);//NO i18N
        }
      case 0x89:
        ...
        return "mov  [" + Register.to32(modrm.reg1) + toHexString(imm32, true) + "], " + Register.to32(modrm.reg2);//NO i18N
      case 0xc6:
        return "mov  byte ptr [" + Register.to32(modrm.reg1) + "], " + toHexString((byte) imm32, false);//NO i18N
      case 0xc7:
        switch (modrm.mod) {
          case 1:
            return "mov  dword ptr [" + Register.to32(modrm.reg1) + toHexString((byte) disp32, true) + "], " + toHexString(imm32, false);//NO i18N
          case 2:
            return "mov  dword ptr [" + Register.to32(modrm.reg1) + toHexString(disp32, true) + "], " + toHexString(imm32, false);//NO i18N
        }
      case 0xa1:
        return "mov  eax, [" + toHexString(imm32, false) + "]";//NO i18N
      case 0xa3:
        return "mov  [" + toHexString(imm32, false) + "], eax";//NO i18N
    }

    return "MOV: UNKNOWN";//NO i18N
  }
}
